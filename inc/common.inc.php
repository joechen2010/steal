...
define('PHP168_PATH', ROOT_PATH);	//兼容旧版
...
unset($webdb,$Html_Type,$erp,$ltitle,$memberlevel,$showHtml_Type,$chdb,$fidDB,$rsdb,$ModuleDB,$city_DB,$Mdomain,$Murl,$linkdb,$choose_class,$foot_tpl,$head_tpl);
